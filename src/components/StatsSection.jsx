// src/components/StatsSection.jsx (VERSI FINAL YANG SUDAH TERBUKTI)
    ...
    <section className={styles.statsSection}>
      <div className={styles.wave}>
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path 
            fill="#F5F0F6" // Warna krem yang sudah terbukti berhasil
      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.statItem}>
            ...
            <p className={styles.number}>1,000+</p>
            <p className={styles.label}>Success Processes</p>
          </div>
          <div className={styles.statItem}>
            <div className={styles.iconWrapper}><FaStar /></div>
            <p className={styles.number}>1+ Years</p>
            <p className={styles.label}>of Experience</p>
          </div>
        </div>
      </div>
    </section>
